 ...
 */
// src/image-processing/image-loader.js
...
export function loadImageData(imagePath, callback) {
  sharp(imagePath)
    ...
    .toBuffer((err, data, info) => {
      ...
      // You can now process the image data in the raw format
      const { width, height, channels } = info;
      console.log(`Loaded image with dimensions: ${width}x${height} and ${channels} channels`);
      
      // Return image data in the format that your code expects
      // For example, you might pass the data as an object
      callback(data);
    });
}
