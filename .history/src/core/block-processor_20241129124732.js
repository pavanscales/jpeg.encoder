 ...
 */
 ...
 export function splitIntoBlocks(imageData) {
    if (!imageData || imageData.length === 0) {
      console.error('Invalid image data provided to splitIntoBlocks');
      return [];
    }
  
    // Assuming 8x8 blocks (you can adjust this based on your requirements)
    const blockSize = 8;
    const blocks = [];
    ...
    console.log('Blocks:', blocks);  // Log blocks to check the result
    return blocks;
  }
